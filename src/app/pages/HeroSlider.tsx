              ...
              >
                <div className="bg-white border-2 border-slate-100 rounded-[2.5rem] overflow-hidden shadow-xl shadow-slate-200/50 hover:border-blue-500 transition-all group flex flex-col h-full relative">
                   ...
                   <div className="aspect-[16/10] overflow-hidden">
                      <img src={item.image} alt={item.title} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" onError={(e) => (e.currentTarget.style.display = 'none')} />
                   </div>
        ...
        <div className="flex justify-center">
          <div className={clsx(
            ...
            <div className="absolute inset-0">
               <img src={items[0].image} alt="Preview" className="w-full h-full object-cover brightness-50" onError={(e) => (e.currentTarget.style.display = 'none')} />
